package com.lovin.soa.remote.servlet;
...
public class DispatcherServlet extends HttpServlet{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5119226916768721282L;
	...
	private Method getMethod(Object bean, String methodName,
        ...
        //如果大小是1就说明相同的方法只有一个,多个表示重载
        if (retMethod.size() == 1) {
            return retMethod.get(0);
        }
        
        boolean isSameSize = false;
        boolean isSameType = false; //类型是否一样
        
        lovin:for (Method method : retMethod) {
