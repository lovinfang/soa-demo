...
import com.lovin.soa.rmi.SoaRmi;

/** 
 * @Description RMi的通讯协议,底层就是Socket，只能是再java语言中进行通讯，不能跨源
 * @ClassName   RmiInvoke 
 * @Date        2018年08月11日 下午5:06:47 
 * @Author      lovin 
 */
public class RmiInvoke implements Invoke{
	...
	public String invoke(Invocation invocation) throws Exception {
		try {
            ...
            SoaRmi soarmi = rmi.startRmiClient(nodeinfo, "lovinsoarmi");
