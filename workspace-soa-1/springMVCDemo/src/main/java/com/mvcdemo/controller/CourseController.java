...
public class CourseController {
	...
	//基础方式  http://localhost:8080/springMVCDemo/courses/view?courseId=124   @RequestParam
	...
	//现代方式  Restful http://localhost:8081/courses/view2/345  @PathVariable
	...
	//http://localhost:8081/courses/admin?add
	@RequestMapping(value="/admin", method = RequestMethod.GET, params = "add")
	public String createCourse(){
		return "course_admin/edit";    // course_admin/edit.jsp
	}
	...
	// http://localhost:8081/courses/upload
	...
	// http://localhost:8081/course_json.jsp?courseId=123  
	// course_json.jsp不能放在web-inf下面，因为web-inf下面用户是看不到的
}
